...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Current contact information and support limitations for Japan eSIM Guide.",
};
...
export default function ContactPage() {
  return (
    <LegalPage
      eyebrow="Contact"
      title="Contact Japan eSIM Guide"
      ...
      sections={[
        {
          ...
          paragraphs: [
            "Japan eSIM Guide does not currently provide a public email address, telephone number, postal address, or contact form.",
        ...
        },
        {
          ...
          paragraphs: [
            "Japan eSIM Guide does not process orders, activate eSIMs, issue SIM cards, deliver pocket Wi-Fi, cancel plans, or approve refunds.",
